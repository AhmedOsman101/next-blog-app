...
const EmptyResource = ({ resource }) => {
	...
	return (
		<>
			<section className="grid place-items-center h-full w-full my-12">
				<div className="container flex flex-col items-center justify-center px-5 mx-auto space-y-8 text-center sm:max-w-md">
					...
					<p className="text-2xl">
						Looks like you have no {resource} yet
					</p>
					<button
						onClick={refresh}
						className="px-8 py-3 font-semibold transition-colors duration-500 rounded dark:bg-blue-600 hover:dark:bg-blue-500 dark:text-gray-50">
						Refresh
					</button>
				</div>
			</section>
